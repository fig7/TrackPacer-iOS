...
let rtMap = [
  ...
  "rt_1000m_AS_l1"  : [R.string.laps_1000, R.string.ll_200m, R.string.ll_3, R.drawable.rt_1000_l1_a, R.drawable.rt_1000_l1_a_ck],
  "rt_1000m_AS_l2"  : [R.string.laps_1000, R.string.ll_200m, R.string.ll_3, R.drawable.rt_1000_l2_a, R.drawable.rt_1000_l2_a_ck],
  "rt_1000m_AS_l3"  : [R.string.laps_1000, R.string.ll_200m, R.string.ll_3, R.drawable.rt_1000_l3_a, R.drawable.rt_1000_l3_a_ck],
  "rt_1000m_AS_l4"  : [R.string.laps_1000, R.string.ll_200m, R.string.ll_3, R.drawable.rt_1000_l4_a, R.drawable.rt_1000_l4_a_ck],
  "rt_1000m_AS_l5"  : [R.string.laps_1000, R.string.ll_200m, R.string.ll_3, R.drawable.rt_1000_l5_a, R.drawable.rt_1000_l5_a_ck],
  "rt_1000m_AS_l6"  : [R.string.laps_1000, R.string.ll_200m, R.string.ll_3, R.drawable.rt_1000_l6_a, R.drawable.rt_1000_l6_a_ck],
  "rt_1000m_AS_l7"  : [R.string.laps_1000, R.string.ll_200m, R.string.ll_3, R.drawable.rt_1000_l7_a, R.drawable.rt_1000_l7_a_ck],
  "rt_1000m_AS_l8"  : [R.string.laps_1000, R.string.ll_200m, R.string.ll_3, R.drawable.rt_1000_l8_a, R.drawable.rt_1000_l8_a_ck],
  ...
  "rt_3000m_AS_l1"  : [R.string.laps_3000, R.string.ll_200m, R.string.ll_8, R.drawable.rt_1000_l1_a, R.drawable.rt_1000_l1_a_ck],
  "rt_3000m_AS_l2"  : [R.string.laps_3000, R.string.ll_200m, R.string.ll_8, R.drawable.rt_1000_l2_a, R.drawable.rt_1000_l2_a_ck],
  "rt_3000m_AS_l3"  : [R.string.laps_3000, R.string.ll_200m, R.string.ll_8, R.drawable.rt_1000_l3_a, R.drawable.rt_1000_l3_a_ck],
  "rt_3000m_AS_l4"  : [R.string.laps_3000, R.string.ll_200m, R.string.ll_8, R.drawable.rt_1000_l4_a, R.drawable.rt_1000_l4_a_ck],
  "rt_3000m_AS_l5"  : [R.string.laps_3000, R.string.ll_200m, R.string.ll_8, R.drawable.rt_1000_l5_a, R.drawable.rt_1000_l5_a_ck],
  "rt_3000m_AS_l6"  : [R.string.laps_3000, R.string.ll_200m, R.string.ll_8, R.drawable.rt_1000_l6_a, R.drawable.rt_1000_l6_a_ck],
  "rt_3000m_AS_l7"  : [R.string.laps_3000, R.string.ll_200m, R.string.ll_8, R.drawable.rt_1000_l7_a, R.drawable.rt_1000_l7_a_ck],
  "rt_3000m_AS_l8"  : [R.string.laps_3000, R.string.ll_200m, R.string.ll_8, R.drawable.rt_1000_l8_a, R.drawable.rt_1000_l8_a_ck],
  ...
  "rt_5000m_AS_l1"  : [R.string.laps_5000, R.string.ll_200m, R.string.ll_13, R.drawable.rt_1000_l1_a, R.drawable.rt_1000_l1_a_ck],
  "rt_5000m_AS_l2"  : [R.string.laps_5000, R.string.ll_200m, R.string.ll_13, R.drawable.rt_1000_l2_a, R.drawable.rt_1000_l2_a_ck],
  "rt_5000m_AS_l3"  : [R.string.laps_5000, R.string.ll_200m, R.string.ll_13, R.drawable.rt_1000_l3_a, R.drawable.rt_1000_l3_a_ck],
  "rt_5000m_AS_l4"  : [R.string.laps_5000, R.string.ll_200m, R.string.ll_13, R.drawable.rt_1000_l4_a, R.drawable.rt_1000_l4_a_ck],
  "rt_5000m_AS_l5"  : [R.string.laps_5000, R.string.ll_200m, R.string.ll_13, R.drawable.rt_1000_l5_a, R.drawable.rt_1000_l5_a_ck],
...
func rtKeyFromArgs(_ baseDist: String, _ startType: String, _ runLane: Int) -> String {
  ...
  if(altDist && (startType == "Home")) {
    modString = "_AS"
  } else if(startType == "Road") {
    modString = "_RD"
  } else {
    modString = ""
  }

  let laneString = (startType == "Road") ? "" : ("_l" + runLane.toString())
  let rtKey = "rt_" + baseDist + modString + laneString
  return rtKey
}

func rtLaps(_ baseDist: String, _ startType: String, _ runLane: Int) -> String {
  let rtKey   = rtKeyFromArgs(baseDist, startType, runLane)
  let rtArray = rtMap[rtKey]!
  return rtArray[0]
}

func rtDesc1(_ baseDist: String, _ startType: String, _ runLane: Int) -> String {
  let rtKey = rtKeyFromArgs(baseDist, startType, runLane)
  let rtArray = rtMap[rtKey]!
  return rtArray[1]
}

func rtDesc2(_ baseDist: String, _ startType: String, _ runLane: Int) -> String {
  let rtKey = rtKeyFromArgs(baseDist, startType, runLane)
  let rtArray = rtMap[rtKey]!
  return rtArray[2]
}

func rtOverlay(_ runDist: String, _ startType: String, _ runLane: Int, _ runClockwise: Bool) -> String {
  let rtKey = rtKeyFromArgs(runDist, startType, runLane)
  let rtArray = rtMap[rtKey]!
